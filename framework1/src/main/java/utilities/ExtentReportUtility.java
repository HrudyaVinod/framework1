...
public class ExtentReportUtility implements ITestListener {
	...
	public void configureReport() {
		...
		sparkReporter.config().setDocumentTitle("Extent Report Sample");// sparkReporter ExtentReport reference
	...
	public void onFinish(ITestContext context) {
		reports.flush();// final output file will generate by flush method ,flush method will run on
						// onFinish method
	}
